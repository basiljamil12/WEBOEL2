            ...
            <div className="col-sm-6 text-black">
              <div className="px-5 ms-xl-4">
                <i
                  ...
                  style={{ color: "#709085" }}
                />
                <h1 style={{fontSize: "70px", marginBottom: "0px", marginTop: "80px",marginLeft:"0px" }}>
                  Delete
                </h1>
              </div>
              <div style={{ marginTop: "50px" }} className="d-flex align-items-center px-5 ms-xl-4 pt-xl-0">
                <form style={{ width: "23rem" }}>
                  ...
                  <button style={{marginLeft:"180px" }} className="btn btn-outline-info btn-lg btn-block" onClick={() => { onSubmit() }}>Delete</button>
                    <br />
                  </div>
                </form>
              </div>
